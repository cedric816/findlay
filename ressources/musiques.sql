...
--
-- Hôte : localhost:3306
-- Généré le : ven. 02 avr. 2021 à 09:43
...
--
-- Structure de la table `artists_styles`
--

CREATE TABLE `artists_styles` (
  `artist_style_id` int NOT NULL,
  `artist_style_artist_id` int NOT NULL,
  `artist_style_style_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

--
-- Déchargement des données de la table `artists_styles`
--

INSERT INTO `artists_styles` (`artist_style_id`, `artist_style_artist_id`, `artist_style_style_id`) VALUES
(2, 1, 4),
(3, 1, 44),
(10, 5, 348),
(11, 6, 170),
...
--
-- Index pour la table `artists_styles`
--
ALTER TABLE `artists_styles`
  ADD PRIMARY KEY (`artist_style_id`),
  ADD KEY `artist_style_artist_id` (`artist_style_artist_id`),
  ADD KEY `artist_style_style_id` (`artist_style_style_id`);
...
--
ALTER TABLE `artists`
  MODIFY `artist_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT pour la table `artists_styles`
--
ALTER TABLE `artists_styles`
  MODIFY `artist_style_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT pour la table `genres`
--
ALTER TABLE `genres`
  MODIFY `genre_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT pour la table `styles`
--
ALTER TABLE `styles`
  MODIFY `style_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=607;
...
--
-- Contraintes pour la table `artists_styles`
--
ALTER TABLE `artists_styles`
  ADD CONSTRAINT `artists_styles_ibfk_1` FOREIGN KEY (`artist_style_artist_id`) REFERENCES `artists` (`artist_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `artists_styles_ibfk_2` FOREIGN KEY (`artist_style_style_id`) REFERENCES `styles` (`style_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `styles`
--
ALTER TABLE `styles`
  ADD CONSTRAINT `styles_ibfk_1` FOREIGN KEY (`style_genre_id`) REFERENCES `genres` (`genre_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
